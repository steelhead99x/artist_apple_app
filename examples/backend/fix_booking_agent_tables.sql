-- Fix for Booking Agent User Visibility Issue
-- This creates the missing tables needed for booking agent functionality
-- Safe to run - uses IF NOT EXISTS

-- Enable UUID extension (required for the tables)
...
DO $$
BEGIN
  RAISE NOTICE '✅ Booking agent tables created/verified successfully!';
  RAISE NOTICE 'Tables: user_billing_adjustments, user_features, user_states, booking_manager_assignments';
END $$;
